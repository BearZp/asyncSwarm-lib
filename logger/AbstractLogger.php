...
abstract class AbstractLogger extends PsrAbstractLogger
{
     ...
     */
    public function __construct(string $limitLevel = '')
    {
    ...
    public function log($level, $message, array $context = []): void
    {
        if ($this->filterLevel($level)) {
            $this->write($this->getPacket($level, $message, $context));
        }
    }
     ...
     * @param string $packet
     */
    abstract protected function write(string $packet): void;
     ...
     * @return string
     */
    private function getPacket(string $level, string $message, array $context = []): string
    {
        $packet = [];
     ...
     * @return array
     */
    private function flattenException(\Throwable $exception): array
    {
        $dump = [];
     ...
     * @return string
     */
    private function getRfcTime(): string
    {
